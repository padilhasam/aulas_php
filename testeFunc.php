<?php
	//Teste de exemplo de funções
		...
		function um($valores){
			...
			$dados = array('nome' => "Antonio", 'sobrenome' => "Pereira"); //$dados recebe um array com valores.	
		...
		function dois($valores){
			...
			$dados = array('Nome' => "Fernando", 'Sobrenome' => "Alves"); //Cria um array e salva dentro da variável $dados.
